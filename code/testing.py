...
bg1='#2b263f' #2b263f
root.configure(background = bg1)#0f1c4d #4380b0 #3a668b #172a41 #29445b #1b1626 #2b263f #a74e46

head = Label( text ='WELCOME ' + name_str, bg = '#323150', fg = '#aba9b5', font = ('Bahnschrift Light Condensed', 25, 'bold'))
